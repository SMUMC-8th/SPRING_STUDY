...
public interface ReplyRepository extends JpaRepository<Reply, Long> {
    List<Reply> findAllByArticleIdIsOrderByCreatedAtDesc(Long articleId);
    Page<Reply> findAllByArticleIdIsOrderByCreatedAtDesc(Long articleId, Pageable pageable);
